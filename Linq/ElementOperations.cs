...
namespace Linq
{
	...
	public static class ElementOperations
	{
		...
		public static Product FirstElement()
		{
			...
			return products.FirstOrDefault(x => x.ProductId == 11);
		}
		...
		public static string FirstMatchingElement()
		{
			...
			return strings.FirstOrDefault(x => x.StartsWith('o'));
		}
		...
		public static Product MaybeFirstMatchingElement()
		{
			...
			return products.SingleOrDefault(x => x.ProductId == 789);
		}
		...
		public static int ElementAtPosition()
		{
			...
			return numbers.Where(x => x > 5).ElementAtOrDefault(1);
		}
		...
		public static string LastMatchingElement()
		{
			...
			return strings.LastOrDefault(x => x.Contains('o'));
		}
		...
		public static string MaybeSingleMatchingElement()
		{
			...
			var matchingElements = strings.Where(x => x.Contains('o')).ToList();

			return matchingElements.Count == 1 ? matchingElements.SingleOrDefault() : null;
		}
	}
}